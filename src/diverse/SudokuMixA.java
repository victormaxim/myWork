...
public class SudokuMixA {
    ...
    if (solve(0,0,matrix)){    // solves in place
	    ...
	    System.out.println("That took "+(timeEnd-timeStart)/1000+" seconds to complete.");
    }
	else 
	...
	for (int val = 1; val <= 9; ++val) {
		...
		cells[i][j] = val; //MainClass.a;	//tries++;
		if (solve(i+1,j,cells))  {
			//System.out.println(++i + "-" + ++j + " (" + tries + "): " + val);
			return true;	}
	    }
	}
